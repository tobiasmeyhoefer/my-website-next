...
const BentoSection = () => {
  return (
    <section className="p-6 xl:p-20 pb-40 my-12 md:text-sm text-[12px]">
      <h2 className="text-4xl ml-8 mb-12 font-bold">Else</h2>
      <div className="grid-container md:p6 p-0 font-montserrat font-bold">
        ...
        <div className="item6 flex">
          <p className="z-10 relative top-2 font-medium text-[12px]">basics</p>
          <Image className="w-16 absolute" src={turkey} alt="turkey"/>
        </div>
        <div className="item7 flex gap-8">
          <p>English (fluent)</p>
          <Image className="w-12" src={england} alt="england"/>
          </div>
        ...
        <Image className="w-12" src={denmark} alt="denmark"/>
        </div>
