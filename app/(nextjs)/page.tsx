...
import star from "@/public/svg/star2.svg";
      ...
      <BackgroundBeamsWithCollision>
        <section className="flex h-[calc(100vh-100px)] w-full flex-col items-center justify-center">
          <div className="relative flex -translate-y-[120px] flex-col items-center justify-center md:-translate-y-[120px]">
            ...
            <div className="pointer-events-none 2xl:-left-[14%]] absolute left-[-20%] top-[-40%] h-20 w-20 rounded-full bg-white opacity-80 blur-2xl dark:bg-background lg:left-[-15%] lg:top-[-120%] lg:size-40 2xl:-top-[120%] 2xl:size-60"></div>
          </div>
